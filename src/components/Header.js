            ...
            <section id="home" className="header-section">
                <div id="header-container" className="header-container container">
                    <div id="welcome" className="welcome">
                        ...
                        <p id="welcome-info" className="welcome-info">Software Engineer and Web Developer. I build things.</p>
                        <p id="welcome-sectors" className="welcome-sectors"><span>AI</span><span>Web</span><span>Security</span></p>
                    </div>
                </div>
