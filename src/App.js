...
export default class App extends React.Component {
    ...
    project_icons = {
        ...
        "mail": {
            ...
            link_title: 'Contact Alberto to know more!'
        }
    };
    ...
    projects = [ 
        {
            ...
            more: 'https://github.com/gpisanelli/ProgettoCV',
        ...
        },
        {
            ...
            more: 'https://github.com/albjerto/EsameISS2019',
            link_title: this.project_icons['github'].link_title,
            icon: this.project_icons['github'].icon,
